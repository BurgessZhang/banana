package com.burgess.excel.config.util;
	...
	public static List<ExcelField> loadAnnotationConfig(Class<?> beanConfigClass) {
		if (beanConfigClass == null) {
			String msg = String.format(
					"the value param of  AnnotationUtil.loadAnnotationConfig(Class<?> beanConfigClass) is null. ");
			logger.error(msg);
		...
		if (excelSheet == null) {
			String msg = String.format(
					"the value param of  AnnotationUtil.loadAnnotationConfig(Class<?> beanConfigClass = %s) has not excelSheet Annotation.",
		...
		if (fields == null || fields.length <= 0) {
			...
			String msg = String.format(
					"the value param of  AnnotationUtil.loadAnnotationConfig(Class<?> beanConfigClass = %s) does not have DeclaredField.",
					beanConfigClass.getName());
			logger.error(msg);
			throw new RuntimeException(msg);
		}
		...
		if (fieldAnnotationCount == 0) {
			...
			String msg = String.format(
					"the value param of  AnnotationUtil.loadAnnotationConfig(Class<?> beanConfigClass = %s) does not have Annotation DeclaredField.",
					beanConfigClass.getName());
			logger.error(msg);
			throw new RuntimeException(msg);
		}
